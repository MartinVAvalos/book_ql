<template>
  <nav class="main-nav">
    ...
    <header class="library-header nav-left">
...
.main-nav {
  ...
  align-items: center;
  // background: linear-gradient(to right, $blue 0%, $green 33%, $orange 66%, $yellow 100%);
  width: 100%;
  height: 100%;
...
.nav-item a {
  ...
  &.router-link-active {
    ...
    font-weight: 500;
    text-shadow: 0.5px 0 0 currentColor; /* Simulate bold without changing width */
  }
}
